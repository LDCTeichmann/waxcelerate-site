...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: 'Pro-Formel kompakt — für Fahrer, die zwischen Sommer und Winter die Formel wechseln, oder als Block für die nassen Monate.',
    descriptionEn: 'Pro formula compact — for riders who switch between summer and winter formulas, or as a block for the wet months.',

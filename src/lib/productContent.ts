...
const v9SharedChainCompRows = [
  ...
  { label: 'Kettenlaufzeit', good: '2–3× länger', bad: 'Basis' },
  { label: 'Aufwand', good: 'Einbauen & fahren', bad: 'Alle 100–150 km ölen' },
];

// Kein "Made in Germany" fuer die zugekauften Ketten: die baut Shimano, SRAM
// bzw. YBN, in Stuttgart passiert ausschliesslich die Wachsbehandlung. Die
// Herkunftsangabe waere damit irrefuehrend. SICHTBARKEIT_PLAN.md §5 haelt die
// Regel ausdruecklich fest ("Hergestellt in Stuttgart", nie "Made in Germany"
// fuer die Ketten) und fuehrt den Verstoss in §9 Phase 7 als Rechtsrisiko —
// dort allerdings nur fuer eBay und Kleinanzeigen, dass er auch hier stand,
// war unbemerkt. Beim Wachs selbst bleibt "Made in Germany" richtig.
const v9ChainFooterNote = 'Wachsbehandlung in Stuttgart — frisch behandelt, direkt versandt. Versand 1–2 Werktage. Selbst wachsen? Waxcelerate MoS₂ Edition 300g / 500g — gleiche Formulierung, für alle Ketten.';
...
const waxCompRowsClassic = [
  ...
  { label: 'Kettenlaufzeit', cols: ['2–3× länger als Öl', '2–4× länger als Öl', 'Basis'], winCol: 0, dimCols: [2] },
];

export const translations = {
  de: {
    ...
    tools: {
      ...
      // Umstieg
      switch: {
        title: 'Ab wann lohnt sich Wachs für dich?',
        subtitle: 'Einkaufsliste, Kostenverlauf gegen Öl und der Monat, ab dem du im Plus bist.',
        paidOffOne: 'Monat, dann bist du im Plus',
        paidOffMany: 'Monate, dann bist du im Plus',
  ...
  en: {
    ...
    tools: {
      ...
      switch: {
        title: 'When does wax pay off for you?',
        subtitle: 'Shopping list, cost over time against oil, and the month you come out ahead.',
        paidOffOne: 'month to break even',
        paidOffMany: 'months to break even',

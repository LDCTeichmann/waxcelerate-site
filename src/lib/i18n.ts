  ...
  de: {
    ...
    tools: {
      ...
      rewax: {
        ...
        derivation: '{weather} · {terrain}: {interval} km je Wachsung. Bei {km} km/Woche fällt das alle {weeks} an.',
        sinceLabel: 'seit dem Waxen',
        dueLabel: 'fällig',
      },
      profile: {
        barTitle: 'Dein Fahrprofil',
        barHint: 'Gilt für Intervall, Umstieg und Ersparnis',
      ...
      wear: {
        ...
        helpMethod: 'Ohne Werkzeug reicht ein Stahllineal: Kette straff ziehen, einen Bolzen genau auf die Null legen und schauen, wie weit der zwölfte Bolzen über der 12-Zoll-Marke (304,8 mm) steht — diesen Überstand trägst du ein. Eine Kettenlehre gibt schneller ein Ja/Nein und ist für 11- und 12-fach die verlässlichere Wahl, weil man 1,5 mm über 30 cm von Hand kaum genau abliest.',
        helpMeasured: 'Kette straff ziehen, einen Bolzen genau auf die Null legen und über 12 volle Glieder zur 12-Zoll-Marke (304,8 mm) messen. Nur der Überstand zählt: 1/16 Zoll (rund 1,5 mm) sind 0,5 % Längung, 1/8 Zoll (rund 3 mm) sind 1,0 %.',
        enterValue: 'Überstand über die 12-Zoll-Marke messen und eintragen.',
        overshoot: '{mm} mm über der Neulänge von 304,8 mm.',
        rulerNote: 'Das Lineal misst genau genug, solange die Kette wirklich straff gezogen ist — sonst zeigt der Durchhang zu wenig an. Für 11- und 12-fach ist eine Kettenlehre die schnellere und verlässlichere Wahl.',
      ...
      length: {
        ...
        fieldsInline: 'Kettenstrebe = unteres Rohr, Tretlager → Hinterachse (Rennrad ~410 mm, MTB ~430 mm). Kettenblatt und Ritzel sind die jeweils größten Zähnezahlen.',
      ...
      switch: {
        ...
        needList: 'Was du zum Start brauchst',
  ...
  en: {
    ...
    tools: {
      ...
      rewax: {
        ...
        derivation: '{weather} · {terrain}: {interval} km per wax. At {km} km/week that comes round every {weeks}.',
        sinceLabel: 'since the wax',
        dueLabel: 'due',
      },
      profile: {
        barTitle: 'Your riding profile',
        barHint: 'Used by interval, switching and savings',
      ...
      wear: {
        ...
        helpMethod: 'A steel ruler works: pull the chain taut, line up one pin exactly with zero and see how far the 12th pin sits past the 12-inch mark (304.8 mm) — that overshoot is what you enter. A chain gauge gives a faster yes/no and is the safer choice for 11- and 12-speed, since 1.5 mm over 30 cm is hard to read by hand.',
        helpMeasured: 'Pull the chain taut, line up one pin exactly with zero and measure across 12 full links to the 12-inch mark (304.8 mm). Only the overshoot counts: 1/16 inch (about 1.5 mm) is 0.5 % elongation, 1/8 inch (about 3 mm) is 1.0 %.',
        enterValue: 'Measure the overshoot past the 12-inch mark and enter it.',
        overshoot: '{mm} mm over the new length of 304.8 mm.',
        rulerNote: 'A ruler is accurate enough as long as the chain is really pulled taut — otherwise the sag reads low. For 11- and 12-speed a chain gauge is the faster, more reliable choice.',
      ...
      length: {
        ...
        fieldsInline: 'Chainstay = lower tube, bottom bracket → rear axle (road ~410 mm, MTB ~430 mm). Chainring and sprocket are the largest tooth counts on each.',
      ...
      switch: {
        ...
        needList: 'What you need to start',

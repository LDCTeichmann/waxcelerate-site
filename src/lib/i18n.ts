export const translations = {
  de: {
    ...
    cart: {
      ...
      vatNote: 'Gem. §19 UStG wird keine MwSt. ausgewiesen · Versand wird im Checkout berechnet',
  ...
  en: {
    ...
    cart: {
      ...
      subtotal: 'Subtotal',
      vatNote: 'No VAT charged (§19 UStG small business) · Shipping calculated at checkout',

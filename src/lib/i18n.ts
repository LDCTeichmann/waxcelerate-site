export const translations = {
  de: {
    ...
    header: {
      ...
      // Nur auf /kette-wachsen-lassen*: dort gilt „versandkostenfrei" nicht,
      // der Kunde trägt beim Service das Porto ({ship}, {turn} aus rewax/content.ts).
      rewaxServiceA: 'Nichts vorreinigen · Rückversand ab {ship}',
      rewaxServiceB: 'Bearbeitung {turn}',
    ...
    hero: {
      ...
      tagline: 'Heißwachs statt Kettenöl. Kein schwarzer Film an Kette und Wade, zwei- bis dreimal längere Kettenlaufzeit.',
      // Hero v6 (Stuttgart-Panorama). Die Flagge steht als kleines SVG davor,
      // der Ort als Bildunterschrift im Foto: das Bild belegt die Herkunft,
      // der Text muss sie nicht behaupten.
      originLine: 'Handgegossen in Stuttgart',
      locationMark: 'Stuttgart · 48,78° N',
      reviewsLine: 'Bewertungen auf eBay',
      reviewsShort: 'Bewertungen',
      perApplication: 'pro Wachsgang',
      whichIsYours: 'Welcher ist deiner?',
      priceAnchor: 'Ab €22,95 · ~€127 gespart auf 12.000 km',
    ...
    whyWax: {
      ...
      // „Was sich für dich ändert": Startseite (why-wax.tsx) und Wachsseite
      // (ProofAndChange.tsx) teilen sich diese vier Punkte. „Es wird leise"
      // bleibt draußen, bis Luca den Claim freigibt (PROJECT.md).
      changeEyebrow: 'Öl vs. Wachs',
      changeTitle: 'Was sich für dich ändert.',
      changeLead: 'Wachs härtet trocken aus. Alles Weitere folgt daraus.',
      points: [
      ...
      proofRef: 'Referenz',
      captionPhoto: 'Dieselbe Kette, links geölt, rechts gewachst. Zum Vergleichen ziehen.',
      captionMicro: 'Innenfläche eines Kettenglieds, dort wo der Bolzen läuft.',
      figLife: 'Längere Kettenlaufzeit',
      figLifeSub: 'Kassette und Kettenblätter halten mit.',
      figInterval: 'Intervall trocken',
      figIntervalSub: 'Statt nach jeder Regenfahrt ölen.',
      figWatts: 'Antriebsverlust',
      figSaved: (km: string) => `Gespart auf ${km} km`,
      cta: 'Wachs wählen',
      ctaNote: (price: string) => `Ab ${price} · versandkostenfrei`,
      // Runde 2: Beleg-Links in den Punkten schalten den Slider um.
      seePhoto: 'Foto ansehen',
      seeMicro: 'Unterm Mikroskop ansehen',
      wattsShort: (oil: string, input: string) => `statt ${oil} · bei ${input}`,
    ...
    tools: {
      ...
      rewax: {
        ...
        gravel: 'Gravel',
        mtb: 'MTB',
        kmPerWeek: 'km pro Woche',
        lastWaxed: 'Zuletzt gewachst',
        lastWaxedClear: 'Datum löschen',
        lastWaxedToday: 'Heute',
        lastWaxed1Week: 'Vor 1 Woche',
        lastWaxed2Weeks: 'Vor 2 Wochen',
        lastWaxedExact: 'Genaues Datum →',
        lastWaxedHideExact: 'Ausblenden',
        subtitle: 'Aus Wetter, Gelände und Kilometern — mit Termin für den Kalender.',
        inDays: 'in {n} Tagen',
        inOneDay: 'morgen',
        dueToday: 'heute fällig',
        overdueBy: 'seit {n} Tagen fällig',
        verdictNext: 'Nächstes Waxen am {date}, danach alle {weeks}.',
        verdictOverdue: 'Die Kette war am {date} dran. Wachsen, dann läuft der Rhythmus von heute an.',
        derivation: '{weather} · {terrain} → {km} km je Wachsung ÷ {kmWeek} km/Woche',
        week: 'Woche',
        weeks: 'Wochen',
        days: 'Tage',
        every: 'alle {n}',
        ...
        reminderDesc: 'Waxcelerate: Kette rewaxen, {rhythm} ({km} km je Wachsung). Das Intervall ändert sich mit Wetter und Saison — nach Regenfahrten früher.',
      },
      profile: {
      ...
      shared: {
        ...
        // Beschriftungen in den Rechner-Grafiken (sketches.tsx)
        sketchTeeth: 'Z',
        sketchRemove: '−{n} Glieder',
        sketchPitch: '1 Glied = 12,7 mm',
        sketchCountNote: 'Innen + außen immer paarweise → Summe gerade',
        sketchQuickLink: 'Kettenschloss',
        sketchExaggerated: 'überzeichnet',
        sketchSaved: 'Gespart im Jahr',
        sketchExtra: 'Mehrkosten im Jahr',
        sketchKm: '{done} von {total} km',
        addGoogle: 'In Google Kalender',
        addIcs: 'Als .ics laden (Apple)',
        addOutlook: 'In Outlook',
        calHead: 'Termin eintragen',
        calGoogle: 'Google',
        calApple: 'Apple',
        calOutlook: 'Outlook',
        calSeries: 'Als Serie: {n} Termine, {rhythm}',
        calOutlookNote: 'Outlook übernimmt nur den ersten Termin.',
        calMore: 'Weitere Kalender',
        traceTitle: 'So rechnen wir',
        traceInterval: 'Intervall',
        traceRhythm: 'Rhythmus',
        traceDue: 'Nächster Termin',
        traceElong: 'Längung',
        traceLimit: 'Tauschgrenze',
        traceGauge: 'Marke {mark} % greift',
        traceGaugeNone: 'keine Marke greift',
        traceTotal: 'Summe im Jahr',
        traceSavings: 'Ersparnis',
        remind: 'Erinnerung',
      ...
      wear: {
        ...
        statusReplace: 'Kette tauschen. Die Kassette darf in aller Regel bleiben.',
        statusCheckCass: 'Kette raus. Die Kassette kann mitgelaufen sein — beim Einbau prüfen, ob die neue Kette sauber greift.',
        statusCassette: 'Kette raus, und die Kassette ist praktisch sicher mitgelaufen.',
        costNow: 'Fälliger Tausch',
        chainOnly: 'nur Kette',
        chainAndCassette: 'Kette + Kassette',
        chainMaybeCassette: 'Kette, evtl. Kassette',
        ...
        verdictOk: 'Fährt noch',
        verdictSoon: 'Bald fällig',
        verdictReplace: 'Kette tauschen',
        verdictCheckCass: 'Kassette prüfen',
        verdictCassette: 'Kette + Kassette',
        verdictWaiting: 'Messen',
        scaleOk: 'fährt',
        scaleReplace: 'tauschen',
        scaleCassette: 'Kassette mit',
        scaleLimit: 'Grenze',
      ...
      length: {
        ...
        links: 'Glieder',
        teeth: 'Zähne',
        note: 'Startwert nach der Park-Tool-Formel, immer auf eine gerade Zahl aufgerundet. Vor dem Kürzen mit der Groß-Groß-Probe gegenprüfen.',
        formula: '0,157 × Kettenstrebe + Kettenblatt ÷ 2 + Ritzel ÷ 2 + 2',
        helpChainstay: 'Der untere Rohrabschnitt vom Tretlager zur Hinterachse. Gemessen wird von Tretlagermitte zu Hinterachsmitte. Rennrad meist 405–425 mm, Mountainbike 425–445 mm.',
        helpChainring: 'Das größte Zahnrad vorne an der Kurbel. Bei nur einem Kettenblatt ist es dieses. Die Zähnezahl steht fast immer auf dem Blatt selbst, sonst zählen.',
        ...
        allBrands: 'Die Formel ist reine Geometrie (½-Zoll-Teilung) und gilt für Shimano, SRAM und Campagnolo gleich; die +2 Glieder entsprechen der Groß-Groß-Probe der Hersteller. Ausnahme: SRAM Transmission (T-Type) — dort gilt SRAMs eigene Längentabelle.',
        ...
        calcWay: 'Rechenweg',
        calcStay: '2 × Strebe {mm} mm ÷ 12,7',
        calcRing: 'Kettenblatt {n} Z ÷ 2',
        calcSprocket: 'Ritzel {n} Z ÷ 2',
        calcReserve: 'Reserve fürs Schaltwerk',
        calcTotal: '= {raw}, auf gerade Zahl aufgerundet',
        modeMeasure: 'Messen',
        modeCount: 'Kette zählen',
        stay: 'Strebe',
        ring: 'Kettenblatt',
        sprocket: 'Ritzel',
        rangeNote: 'Kettenstrebe 350–550 mm, Kettenblatt 20–60 Zähne, Ritzel 9–60 Zähne.',
        countCaption: 'Die neue Kette bekommt dieselbe Länge — wenn die alte gut geschaltet hat.',
        countLabel: 'Gezählte Glieder',
        countRange: 'Rennrad- und MTB-Ketten liegen zwischen 90 und 140 Gliedern.',
        countOdd: 'Ungerade — vermutlich verzählt. Wir rechnen mit {n}.',
        countEnter: 'Gezählte Glieder eintragen.',
      },
      ...
      match: {
        ...
        fits: '{n} passen',
        fitsOne: '1 passt',
        verdictFits: '{brands} — für {system} {speed}-fach, vorgewachst und sofort fahrbereit.',
        exitService: 'Deine eigene Kette auf Wachs umstellen lassen: ab {price} →',
        cheapest: 'Günstigste',
        choice: 'Auswahl',
    ...
    // Footer
    footer: {
      tagline: 'Heißwachs-Kettenpflege aus Stuttgart',
      shop: 'Shop',
      info: 'Info',
      legal: 'Rechtliches',
  ...
  en: {
    ...
    header: {
      ...
      rewaxServiceA: 'No pre-cleaning · return shipping from {ship}',
      rewaxServiceB: 'Processing {turn}',
    ...
    hero: {
      ...
      tagline: 'Hot wax instead of chain oil. No black film on chain or calf, two to three times the chain life.',
      originLine: 'Hand-poured in Stuttgart',
      locationMark: 'Stuttgart · 48.78° N',
      reviewsLine: 'reviews on eBay',
      reviewsShort: 'reviews',
      perApplication: 'per waxing',
      whichIsYours: 'Which is yours?',
      priceAnchor: 'From €22.95 · ~€127 saved over 12,000 km',
    ...
    whyWax: {
      ...
      changeEyebrow: 'Oil vs. Wax',
      changeTitle: 'What changes for you.',
      changeLead: 'Wax sets dry. Everything else follows from that.',
      points: [
      ...
      proofRef: 'Reference',
      captionPhoto: 'The same chain, oiled on the left, waxed on the right. Drag to compare.',
      captionMicro: 'Inner surface of a chain link, exactly where the pin runs.',
      figLife: 'Longer chain life',
      figLifeSub: 'Cassette and chainrings last with it.',
      figInterval: 'Interval, dry',
      figIntervalSub: 'Instead of oiling after every wet ride.',
      figWatts: 'Drivetrain loss',
      figSaved: (km: string) => `Saved over ${km} km`,
      cta: 'Choose your wax',
      ctaNote: (price: string) => `From ${price} · free shipping`,
      seePhoto: 'See the photo',
      seeMicro: 'See it under the microscope',
      wattsShort: (oil: string, input: string) => `vs ${oil} · at ${input}`,
      labValues: 'Lab values',
      derivation: 'How we got there',
      derivationAria: 'Where the savings come from: see the cost breakdown',
    },
    ...
    tools: {
      ...
      rewax: {
        ...
        lastWaxed: 'Last waxed',
        lastWaxedClear: 'Clear date',
        lastWaxedToday: 'Today',
        lastWaxed1Week: '1 week ago',
        lastWaxed2Weeks: '2 weeks ago',
        lastWaxedExact: 'Exact date →',
        lastWaxedHideExact: 'Hide',
        subtitle: 'From weather, terrain and distance — with a date for your calendar.',
        inDays: 'in {n} days',
        inOneDay: 'tomorrow',
        dueToday: 'due today',
        overdueBy: 'due {n} days ago',
        verdictNext: 'Next wax on {date}, then every {weeks}.',
        verdictOverdue: 'The chain was due on {date}. Wax it and the rhythm restarts from today.',
        derivation: '{weather} · {terrain} → {km} km per wax ÷ {kmWeek} km/week',
        week: 'week',
        weeks: 'weeks',
        days: 'days',
        every: 'every {n}',
        rhythm: 'Rhythm',
        perYearFact: 'Per year',
        perYear: '{n}× waxing',
        tlLast: 'last',
        tlToday: 'today',
        tlDue: 'due',
        ...
        reminderDesc: 'Waxcelerate: re-wax the chain, {rhythm} ({km} km per wax). The interval shifts with weather and season — sooner after rain rides.',
      },
      profile: {
      ...
      shared: {
        ...
        sketchTeeth: 'T',
        sketchRemove: '−{n} links',
        sketchPitch: '1 link = 12.7 mm',
        sketchCountNote: 'Inner + outer always in pairs → total even',
        sketchQuickLink: 'Quick link',
        sketchExaggerated: 'exaggerated',
        sketchSaved: 'Saved per year',
        sketchExtra: 'Extra cost per year',
        sketchKm: '{done} of {total} km',
        addGoogle: 'Add to Google Calendar',
        addIcs: 'Download .ics (Apple)',
        addOutlook: 'Add to Outlook',
        calHead: 'Add to calendar',
        calGoogle: 'Google',
        calApple: 'Apple',
        calOutlook: 'Outlook',
        calSeries: 'As a series: {n} dates, {rhythm}',
        calOutlookNote: 'Outlook only takes the first date.',
        calMore: 'More calendars',
        traceTitle: 'How we calculate',
        traceInterval: 'Interval',
        traceRhythm: 'Rhythm',
        traceDue: 'Next date',
        traceElong: 'Elongation',
        traceLimit: 'Replacement limit',
        traceGauge: 'Mark {mark} % drops in',
        traceGaugeNone: 'no mark drops in',
        traceTotal: 'Total per year',
        traceSavings: 'Savings',
        remind: 'Reminder',
        copyLink: 'Copy link',
        share: 'Share',
        copied: 'Copied',
      ...
      wear: {
        ...
        statusCheckCass: 'Replace the chain. The cassette may have worn with it — check that the new chain engages cleanly.',
        statusCassette: 'Chain is done, and the cassette has almost certainly worn with it.',
        costNow: 'Replacement due',
        chainOnly: 'chain only',
        chainAndCassette: 'chain + cassette',
        chainMaybeCassette: 'chain, maybe cassette',
        ...
        verdictOk: 'Still good',
        verdictSoon: 'Due soon',
        verdictReplace: 'Replace chain',
        verdictCheckCass: 'Check cassette',
        verdictCassette: 'Chain + cassette',
        verdictWaiting: 'Measure',
        scaleOk: 'fine',
        scaleReplace: 'replace',
        scaleCassette: 'cassette too',
        scaleLimit: 'Limit',
        scaleYou: 'Your chain',
      ...
      length: {
        ...
        links: 'links',
        teeth: 'teeth',
        note: 'Starting value from the Park Tool formula, always rounded up to an even number. Confirm with the big-big check before shortening.',
        formula: '0.157 × chainstay + chainring ÷ 2 + sprocket ÷ 2 + 2',
        helpChainstay: 'The lower tube from the bottom bracket to the rear axle. Measure centre of bottom bracket to centre of rear axle. Road bikes are usually 405–425 mm, mountain bikes 425–445 mm.',
        helpChainring: 'The largest front cog at the crank. With a single chainring, that is the one. The tooth count is almost always printed on the ring itself.',
        ...
        allBrands: 'The formula is pure geometry (½-inch pitch) and works the same for Shimano, SRAM and Campagnolo; the +2 links match the manufacturers\' big-big check. Exception: SRAM Transmission (T-Type) uses SRAM\'s own length chart.',
        ...
        calcWay: 'Working',
        calcStay: '2 × stay {mm} mm ÷ 12.7',
        calcRing: 'chainring {n} T ÷ 2',
        calcSprocket: 'sprocket {n} T ÷ 2',
        calcReserve: 'slack for the derailleur',
        calcTotal: '= {raw}, rounded up to even',
        modeMeasure: 'Measure',
        modeCount: 'Count chain',
        stay: 'Stay',
        ring: 'Chainring',
        sprocket: 'Sprocket',
        rangeNote: 'Chainstay 350–550 mm, chainring 20–60 teeth, sprocket 9–60 teeth.',
        countCaption: 'The new chain gets the same length — if the old one shifted well.',
        countLabel: 'Links counted',
        countRange: 'Road and MTB chains are between 90 and 140 links.',
        countOdd: 'Odd — probably miscounted. We use {n}.',
        countEnter: 'Enter the links you counted.',
      },
      ...
      match: {
        ...
        fits: '{n} fit',
        fitsOne: '1 fits',
        verdictFits: '{brands} — for {system} {speed}-speed, pre-waxed and ready to ride.',
        exitService: 'Have your own chain switched to wax: from {price} →',
        cheapest: 'Cheapest',
        choice: 'Choice',
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Published drivetrain friction tests place immersive hot wax at around 2–4 watts of friction loss — chain oil under real-world conditions at around 6–10 watts. That's roughly 4–6 watts difference at the chain. The widely cited 'up to 8 watts' figures come from lab tests at 300–400 watts input power. In everyday riding the gap is slightly smaller.",
        },
        {
    ...
    // Footer
    footer: {
      tagline: 'Hot wax chain care from Stuttgart',
      shop: 'Shop',
      info: 'Info',
      legal: 'Legal',
      copyright: '© {year} Waxcelerate · Stuttgart · waxcelerate@gmail.com',
    ...
    // Easter egg
    easterEgg: {
      logoHint: 'Wax secret found! Press ↑↑↓↓←→←→BA for tech specs.',
    },

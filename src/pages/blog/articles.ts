...
export const articles: Article[] = [
...

  {
    ...
    faq: [
      ...
      { q: 'Wie lange muss die Kette im Wachsbad bleiben?', a: '10 bis 15 Minuten. Die Kette ist erst durchtränkt, wenn keine Luftbläschen mehr aus den Gelenken aufsteigen.' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Wachs auf 85–90 °C erhitzen. Kette einhängen. 10–15 Minuten warten, bis keine Luftbläschen mehr aufsteigen.',
          ...
          'Kette montieren: Die Kette ist jetzt steif, das ist normal. Wachsreste vom Kettenschloss wischen, dann schließen und mit gezogener Hinterradbremse kräftig aufs Pedal drücken, bis es hörbar einrastet.',
          'Einfahren: Ein paar Minuten locker kurbeln oder losrollen. Überschüssiges Außenwachs bricht auf und fällt als weiße Flocken ab. Alternativ die Kette vor dem Montieren ein paar Mal über einen Besenstiel ziehen.',
        ],
      },
      {
        type: 'h2',
      ...
      },
      {
        ...
        items: [
          ...
          'Kette montieren (Kettenschloss vorher von Wachs befreien) und ein paar Minuten locker einfahren.',
        ],
      },
      {
        type: 'h2',
      ...
      },
      {
        ...
        items: [
          ...
          'Wachs im Kettenschloss: Erstarrtes Wachs an Schloss und Bolzen verhindert, dass beide Seiten einrasten. Schloss vor der Montage sauber wischen und prüfen, ob es auf beiden Seiten sitzt.',
        ],
      },
      {
        type: 'h2',
    ...
    howTo: {
      ...
      steps: [
        ...
        { name: 'Kette eintauchen', text: 'Kette vollständig ins Wachsbad hängen. Mindestens 10–15 Minuten einwirken lassen, bis keine Luftbläschen mehr aufsteigen.' },
        ...
        { name: 'Kette montieren', text: 'Wachsreste vom Kettenschloss wischen, Kette auflegen, schließen und mit gezogener Hinterradbremse kräftig aufs Pedal drücken, bis das Schloss hörbar einrastet.' },
        { name: 'Einfahren', text: 'Ein paar Minuten locker kurbeln oder losrollen. Überschüssiges Außenwachs bricht auf, das weiße Pulver, das abfällt, ist normal. Alternativ die Kette vor dem Montieren über einen Besenstiel ziehen.' },
      ],
    },
    ctaSlug: 'wax-300',
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'p', text: 'Das ist normal, und kein Defekt. Frisch gewachst sind die Gelenke vom erstarrten Paraffin verklebt. Wer so direkt losfährt, bekommt eine hakelige Schaltung. Der Schritt, den die meisten überspringen: das Einfahren. Kette montieren und ein paar Minuten locker kurbeln, oder vor der Montage ein paar Mal über einen Besenstiel ziehen. Danach läuft sie geschmeidig.' },
      ...
      { type: 'p', text: 'Wenn nichts davon hilft oder der Wachstopf einfach keinen Platz hat: Die Kette kann auch [[eingeschickt und gewachst werden|/kette-wachsen-lassen]], ganz ohne eigenes Equipment.' },
    ],
    ctaSlug: 'wax-500',
    ctaText: 'Classic Heißwachs 500 g ansehen →',
  },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'p', text: 'Wer das verkürzte Winterintervall nicht selbst nachwachsen will, kann die Kette dafür auch einfach [[wachsen lassen|/kette-wachsen-lassen]] und bekommt sie fahrbereit zurück.' },
    ],
    ctaSlug: 'wax-500-mos2',
    ctaText: 'Pro Heißwachs mit MoS₂ ansehen →',
  },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'p', text: 'Die abgekühlte Kette ist steif, das ist normal. Kettenschloss von Wachsresten befreien, Kette montieren und ein paar Minuten locker einkurbeln, bis das überschüssige Wachs aufgebrochen ist. Wer mag, zieht die Kette vorher ein paar Mal über einen Besenstiel. Die ersten 20–30 km sind die Einfahrphase: Überschüssiges Außenwachs bricht ab (das weiße Pulver ist normal), und der Antrieb findet sein finales, leises Niveau. Erst danach beurteilst du die Wachsleistung fair.' },
    ...
    howTo: {
      ...
      steps: [
        ...
        { name: 'Einfahren', text: 'Die abgekühlte, steife Kette montieren (Kettenschloss vorher von Wachs befreien) und ein paar Minuten locker einkurbeln. Die ersten 20–30 km sind Einfahrphase — überschüssiges Außenwachs bricht als normales weißes Pulver ab.' },
      ],
    },
    ctaSlug: 'wax-500',
    ctaText: 'Classic Heißwachs 500 g ansehen →',
  ...
  },
  {
    ...
    faq: [
      { q: 'Ist es normal, dass die Kette nach dem Wachsen steif ist?', a: 'Ja. Frisch gewachst sind die Gelenke vom erstarrten Paraffin leicht verklebt. Die Steifigkeit löst sich nach den ersten Kilometern von selbst, schneller geht es, wenn du nach der Montage ein paar Minuten locker kurbelst oder die Kette vorher über einen Besenstiel ziehst.' },
    ...
    sections: [
      ...
      { type: 'p', text: 'Frisch gewachst sind die Gelenke vom erstarrten Paraffin leicht verklebt. Wenn du das Einfahren übersprungen hast, merkst du das als hakelige Schaltung auf den ersten Metern. Lösung: nach der Montage ein paar Minuten locker kurbeln, oder die Kette vorher ein paar Mal über einen Besenstiel ziehen. Aber auch ohne löst sich die Steifigkeit nach den ersten Kilometern von selbst.' },
      ...
      { type: 'p', text: 'Dicke Wachsbrocken zwischen den Gliedern, die die Schaltung blockieren, deuten auf zu dick aufgetragenes Wachs oder fehlendes Einfahren hin. Kette abnehmen, ein paar Mal über einen Besenstiel ziehen, gröbere Klumpen vorsichtig entfernen. Wenn das Bad zu kühl war, beim nächsten Mal heißer (85–90 °C) arbeiten, dann läuft das Wachs dünner ab.' },
      { type: 'h2', text: 'Wie fahre ich die frisch gewachste Kette am besten ein?' },
      { type: 'p', text: 'Am einfachsten am Rad: Kette montieren und ein paar Minuten locker kurbeln, bis das überschüssige Außenwachs aufgebrochen ist. Alternativ vor der Montage ein paar Mal über einen Besenstiel ziehen. Danach die erste Ausfahrt bewusst als kurze Einfahrrunde planen, nicht als Wertungsfahrt, und erst nach etwa 30 km ein Urteil über die Wachsleistung fällen.' },
